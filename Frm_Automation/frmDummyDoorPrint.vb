Public Class frmDummyDoorPrint
    ...
    Private Sub PrintNewLabels()
        If KPGeneral.User.UserProfile("AutomationViewOnly") = False Then
            ...
            ds = KPGeneral.WebRef_Local.usp_GeDummyDoorLabelsToPrint

            Dim x As Integer
            For x = 0 To ds.Tables(0).Rows.Count - 1
                KPGeneral.PrintZebraCabinetLabelByLabelNoForWrapping4x6(ds.Tables(0).Rows(x)("LabelNo"), ds.Tables(0).Rows(x)("CSID"), "frmDummyDoorPrint", "Print New Labels", False)
    ...
    Private Sub GetPrintedLabels()
        Dim ds As New DataSet
        ds = KPGeneral.WebRef_Local.usp_GetDummyDoorLabelsPrintedToday
    ...
    Private Sub btnReprint_Click(sender As Object, e As EventArgs) Handles btnReprint.Click
        If ugPrintedToday.ActiveRow.Index > -1 Then
            KPGeneral.PrintZebraCabinetLabelByLabelNoForWrapping4x6(ugPrintedToday.ActiveRow.Cells("LabelNo").Text, ugPrintedToday.ActiveRow.Cells("CSID").Text, "frmDummyDoorPrint", "btnReprint", False)
        End If
    End Sub
End Class